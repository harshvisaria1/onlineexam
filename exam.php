  ...
  if($_POST['setid'] == $_SESSION['setid'])
{
	 if(isset($_POST[submitstudent]))
  {
			...
			while($rsqueryst = mysqli_fetch_array($rs))
			{
				...
				{
					$res =  "<br><br><center><font color='#003300'><strong>Student records inserted to exam schedule</strong></font></center>";
					$resi=1;
				}	
			}
  }
...
<table width="597" border="1" class="tftable">
  <tr>
...
?>
  ...
  <tr>
    <td colspan="2" scope="row" align="center"><input type="submit" name="submitloadstudent" id="submit" value="Load students record to add Exam" /></td>
  </tr>
               ...
               <table width="876" border="1" class="tftable">
                 <tr>
			...
			while($rsqueryst = mysqli_fetch_array($rs))
			{
			    ...
			    ?>
                 <tr>
                   ...
                   <input type="submit" name="submitstudent" id="submit" value="Add this students record" />
                   </form>
                   </td>
                 </tr>
               </table>
