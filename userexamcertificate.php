...
include("dbconnection.php");
	...
	//answered questions
	$sqlanswered = "SELECT * FROM results inner join certificate on certificate.examid=exam.examid where examid='$_SESSION[examid]' AND answerid<>'0'";
...
<table width="610" border="1"  class="tftable">
  ...
  <tr>
    ...
    <?php
		$sqlexam1 = "SELECT * FROM exam where subjectcode='$subjectcode[0]' and regno='$_SESSION[regno]'";
  ...
  <tr>
    ...
    <td>   <?php echo $passmarks[1]; ?><td><?php
		$sqlexam1 = "SELECT * FROM exam where subjectcode='$subjectcode[1]' and regno='$_SESSION[regno]'";
	$qexam1 = mysqli_query($con,$sqlexam1);
		if(mysqli_num_rows($qexam1) != 0)
	{	
	$rsexam1 = mysqli_fetch_array($qexam1);
  ...
  <tr>
    ...
    <td><?php
		$sqlexam1 = "SELECT * FROM exam where subjectcode='$subjectcode[2]' and regno='$_SESSION[regno]'";
	$qexam1 = mysqli_query($con,$sqlexam1);
		if(mysqli_num_rows($qexam1) != 0)
	{
		$rsexam1 = mysqli_fetch_array($qexam1);
  ...
  <tr>
    ...
    <td>   <?php echo $passmarks[3]; ?><td><?php
		$sqlexam1 = "SELECT * FROM exam where subjectcode='$subjectcode[3]' and regno='$_SESSION[regno]'";
	$qexam1 = mysqli_query($con,$sqlexam1);
		if(mysqli_num_rows($qexam1) != 0)
	{
	$rsexam1 = mysqli_fetch_array($qexam1);
  ...
  <tr>
    ...
    <td>     <?php echo $passmarks[5]; ?><td><?php
		$sqlexam1 = "SELECT * FROM exam where subjectcode='$subjectcode[5]' and regno='$_SESSION[regno]'";
	$qexam1 = mysqli_query($con,$sqlexam1);
			if(mysqli_num_rows($qexam1) != 0)
	{
	$rsexam1 = mysqli_fetch_array($qexam1);
  ...
  <tr>
    ...
    <td>     <?php echo $passmarks[6]; ?><td><?php
		$sqlexam1 = "SELECT * FROM exam where subjectcode='$subjectcode[6]' and regno='$_SESSION[regno]'";
	$qexam1 = mysqli_query($con,$sqlexam1);
			if(mysqli_num_rows($qexam1) != 0)
	{
	$rsexam1 = mysqli_fetch_array($qexam1);
