  ...
  if($_POST["setid"] == $_SESSION["setid"])
{
	  ...
	  if(isset($_POST["submit"]))
  	{
		...
		$sql="UPDATE students SET  password='$_POST[npassword]', name='$_POST[name]',   dob='$_POST[dateofbirth]', address='$_POST[address]', contactnumber='$_POST[contactnumber]', courseid='$_POST[course]',  status='$_POST[status]', createdat='$text' WHERE regno='$regno'";		
...
?>
  ...
  <tr>
    ...
    <td><input type="text" name="regno" id="regno" value="<?php echo $rs["regno"]; ?>" placeholder="Enter Registration Number" size="25"/></td> </th>
  </tr></td>
  </tr>
  <tr>
