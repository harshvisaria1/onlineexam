...
<table width="931" height="240" border="1">
...
?>        
  ...
  <tr>
    ...
    <td><input type="radio" name="option" id="option" value="1" onclick="updateanswer(<?php echo $_GET[qid]; ?>,<?php echo $resultid; ?>,this.value)"
    <?php
	...
	?>
    />
      <label for="optiona"> <?php echo $fetchquestion["option1"]; ?></label></td>
    </tr>
  <tr>
    <td><strong>&nbsp; Option B</strong></td>
    <td><input type="radio" name="option" id="option" value="2" onclick="updateanswer(<?php echo $_GET[qid]; ?>,<?php echo $resultid; ?>,this.value)"
    <?php
	...
	?>/> 
	<?php echo $fetchquestion[option2]; ?></td>
    </tr>
  <tr>
    <td><strong>&nbsp; Option C</strong></td>
    <td><input type="radio" name="option" id="option" value="3" onclick="updateanswer(<?php echo $_GET[qid]; ?>,<?php echo $resultid; ?>,this.value)" 
    <?php
	...
	?>/>  
	<?php echo $fetchquestion[option3]; ?></td>
    </tr>
    <tr>
      <td><strong>&nbsp; Option D</strong></td>
    <td><input type="radio" name="option" id="option" value="4" onclick="updateanswer(<?php echo $_GET[qid]; ?>,<?php echo $resultid; ?>,this.value)" 
    <?php
	...
	?>/> 
	<?php echo $fetchquestion[option4]; ?></td>
    </tr>
  <tr>
